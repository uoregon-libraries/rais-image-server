...
func TestInfoHandler(t *testing.T) {
	w := request("test-world.jp2/info.json", t)
	...
	assert.Equal("http://example.com/foo/bar/test-world.jp2", data.ID, "JSON-decoded ID", t)
...
func TestInfoRedirect(t *testing.T) {
	...
	assert.Equal("/foo/bar/test-world.jp2/info.json", locHeader[0], "Location header", t)
}
